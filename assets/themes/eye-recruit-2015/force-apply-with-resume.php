...
<form class="apply_with_resume" method="post" action="<?php echo site_url().'/job-seekers/resume/'; ?>"> <!-- echo get_permalink( get_option( 'resume_manager_submit_resume_form_page_id' ) ); -->
