<div id="job-manager-job-dashboard" class="job-manager-job-dashboard">
	<p class="text-center"><?php _e( 'Your listings are shown in the table below.', 'wp-job-manager' ); ?></p>
	<table class="job-manager-jobs table table-bordered">
		<thead>
			<tr>
