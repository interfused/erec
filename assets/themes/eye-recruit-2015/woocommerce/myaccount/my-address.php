...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="u-column<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> col-<?php echo ( ( $oldcol = $oldcol * -1 ) < 0 ) ? 1 : 2; ?> woocommerce-Address network_list">
		<article>
			<div class="article_content">
				<header class="woocommerce-Address-title title">
					<div class="sidebar_title cont_title">
						<h4><?php echo $title; ?></h4>
						<div class="title_edit"><a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="edit"><i class="fa fa-pencil"></i> <?php _e( 'Edit', 'woocommerce' ); ?></a></div>
					</div>
