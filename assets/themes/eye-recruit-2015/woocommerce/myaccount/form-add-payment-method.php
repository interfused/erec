...
if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	...
	<form id="add_payment_method" class="indent" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row text-center">
				...
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt btn btn-primary alt" id="place_order" value="" /><?php esc_attr_e( 'Add Payment Method', 'woocommerce' ); ?></button>
