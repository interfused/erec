...
<div class="table-responsive">
	<table class="account-payment-methods-table table table-bordered">
		<thead>
			<tr>
...
<?php else : ?>
	...
	<p class="woocommerce-Message woocommerce-Message--info woocommerce-info btn btn-primary btn-sm"><?php esc_html_e( 'No saved methods found.', 'woocommerce' ); ?></p>

<?php endif; ?>

<?php do_action( 'woocommerce_after_account_payment_methods', $has_methods ); ?>

<a class="btn btn-primary btn-sm" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add Payment Method', 'woocommerce' ); ?></a>
