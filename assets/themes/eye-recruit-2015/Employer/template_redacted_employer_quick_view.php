<?php
/**
 * Template Name: Redected Employer quick view
 *
				...
				<div class="container-fluid">
					<div class="row">
												    	  	...
												    	  	?>
													    		<article class="<?php echo (($userId == $currentId))? 'current_user' : ''; ?>">
													    			...
													    			<div class="comment_cont row">
														    			...
														    			<div class="col-md-3 text-right"><span class="ecomm"><?php echo $newdate; ?></span></div>
													    			</div>
													    		</article>
												    	<?php   }  ?>
										    		</div>
							    			...
							    			<form class="comments_submit" id="seekercomment" action="" method="post" novalidate="novalidate">
									    		<article>
									    			...
									    			<div class="comment_cont">
											    		...
											    		<button class="btn btn-primary pull-right sent" type="button" id="seekersubmit">Post</button>
											    		<span id="dlt"></span>
									    			</div>
									    			<div class="clearfix"></div>
									    		</article>
						...
						<div class="col-lg-2 col-lg-pull-8 col-md-6 col-md-pull-0">
							<?php get_template_part('Redacted_employer_quick_view/content', 'reda_left_sidebar'); ?>
						</div>
						<div class="col-lg-2 col-md-6">
							<?php get_template_part('Redacted_employer_quick_view/content', 'reda_right_sidebar'); ?>
						</div>
					</div>
				</div>
			</section>
