...
if ( is_user_logged_in() && sizeof( $resumes ) ) : ?>
	<form class="wpcf7-form" method="post"> <!-- apply_with_resume -->
...
<?php else : ?>
	<form class="wpcf7-form" method="post" action="<?php echo get_permalink( get_option( 'resume_manager_submit_resume_form_page_id' ) ); ?>">
