<?php
/**
 * Template Name: Navigation Communications Center page
 *
				...
				<div class="row ">
					<div class="col-md-9">
						...
						<div class=" row">
							<div class="col-sm-4">
								<div class="well">
									<h5>Pre interview Skype</h5>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
									<a href="jascript:void(0);" class="btn btn-default">Go to meeting</a>
								</div>
							</div>

							<div class="col-sm-4">
								<div class="well">
									<h5>Recruiter communications</h5>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
									<a href="jascript:void(0);" data-target="#aboutproblem" data-toggle="modal" id="submitbPobe" ticketid="azuZbqMV" class="btn btn-default">Go to meeting</a>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="well">
									<h5>Employer communications </h5>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
									<a href="jascript:void(0);" class="btn btn-default">Go to meeting</a>
								</div>
							</div>
