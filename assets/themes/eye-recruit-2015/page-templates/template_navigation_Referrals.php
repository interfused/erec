							...
							<div id="pending" class="network_list row">
								<?php foreach ($selectPending as $value) {
									...
									<article>
										...
										<?php
										echo '<h4>'.$value->first_name.' '.$value->last_name.'</h4>';
													...
													<div class="article_content">
														...
														<ul class="network_list_info">
															...
															<li>
																...
																<strong>Member</strong><?php
															}else{ ?>
															<strong>Not a Member</strong><?php
														}
														?>	
													</li>
													<li><span>Message:</span><br><?php echo $value->user_message;?></li>
												</ul>
											</div>
