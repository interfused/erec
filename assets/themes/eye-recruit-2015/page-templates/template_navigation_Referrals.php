					...
					<div class="col-md-9">
						...
						<?php if($view == 'allow'){ ?>
							<div class="search_bar">
								<p><?php echo $cand_name." ".$verb; ?> stored <span id="counttotalref" count="<?php echo $countref; ?>"><?php echo $countref; ?></span> Recommendation(s)</p>
							</div>
						<?php } ?>
					</div>
				</div>
							...
							<?php if($view == 'allow'){ ?>
								<div class="row" id="inv_frn_n_coll">
									<?php foreach ($select as $value) {
										...
										?>
										<div class="col-md-6" id="refralno<?php echo $value->id; ?>">
											<article>
												<img src="<?php echo site_url(); ?>/assets/themes/eye-recruit-2015/img/EyeRecruit_Avitar.jpg" class="img-responsive">
												<div class="article_content">
													<h4>Hello! <br>My Name is <br><?php echo $name; ?></h4>
													<ul class="network_list_info">
														<li class="cu_wordwrap"><span>Email : </span><br><?php echo $email; ?></li>
														<li>
															<span>Status : </span><br>
															<?php 
        ...
        <form class="wpcf7-form">
	      	<div id="userdetail_all_fields">
				<div id="userdetail_pr" class="edit-main-dv form-group row">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label class="control-label" for="Years">How many years have you know each other?</label><br />
