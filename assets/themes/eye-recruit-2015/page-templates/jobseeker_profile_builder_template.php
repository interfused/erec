...
<div class="container">
	          	<?php 
					...
					$args = array("post_type"=>'steps',"post_status"=>'publish','orderby' => 'menu_order','order' => 'ASC',"posts_per_page"=>25);
				 	 			...
				 	 			<form id="profilebuder<?php echo $post_id; ?>" method="post" action="" enctype="multipart/form-data" >
			    					...
			    					<div class="profilestep_inner">
				    					...
				    					<div class="text-center">
											...
											<button type="button" class="continue_step step-btn " id="nextstep" data-pre="<?php echo $previous_post->ID; ?>" data-next="<?php echo $next_postid; ?>" data-steps="<?php echo get_post_meta($post->ID,'steps_url',true); ?>" data-current="<?php echo $post_id; ?>"><i class="fa fa-angle-double-left"></i> <?php  echo get_post_meta($post_id,'cobutton',true); ?> <i class="fa fa-angle-double-right"></i></button>
				    					</div>
									</div>
				    			</form>
							</div>
