<?php
/**
 * Template Name: Preferences access-security page
 *
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 sidemenu_border">
					...
					<form id="change_pass_form_id" class="renewalform">
					...
					<form class="renewalform">
						...
						<div class="indent security_question">
							<div class="row">
								<div class="col-sm-8">
									...
									<ul>
										<li>Always confirm you are on EyeRecruit.com before entering  your password or answering the security question.</li>
								...
								<div class="col-sm-4">
									<?php member_navigation_sidebar_tips_function('seeker_access_sec'); ?>
								</div>
							</div>
							<div class="text-center">
						...
						<div class="sidebar_title cont_title">
							<h4>Log In History</h4>
						</div>
						<div class="indent security_question">
							<p>EyeRecruit provides a secure environment and to help protect against fraud, unauthorized use or access, your current IP address (their IP here) is being logged.</p>
						</div>
						<?php 
							...
							if($count>0){ ?>
								...
								<div class="text-center">
									<a href="<?php echo site_url();  ?>/preferences/login-history/" class="btn btn-default">See Complete History
									</a>
								</div><?php
							}else{
						...
						<div class="sidebar_title cont_title">
							<h4>Activity Logs</h4>
							<!-- <a href="#">If you see something unfamiliar , change your password</a> -->
						...
						<?php 
							...
							if($count>0){ ?>
								...
								<div class="text-center">
									<a href="<?php echo site_url();  ?>/preferences/recent-activity/" class="btn btn-default">See Complete Activity
									</a>
								</div><?php
							}else{
								echo "No results found";
