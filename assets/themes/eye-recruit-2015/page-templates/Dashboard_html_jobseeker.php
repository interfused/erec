...
die;
/**
 * Template Name:Html job seeker dashboard html Page
 *
		...
		<div class="container">
			<div class="name_sec">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<p class="text-center"><strong>Membership Type : </strong>Plus <a href="javascript:void(0);" class="btn btn-sm btn-primary">Upgrade</a></p>
					</div>
					<div class="col-md-3 col-sm-6">
					...
					<div class="profile_box">
						...
						<div class="profile_cont">
							<ul class="view_points row">
								...
								<li class="col-xs-5 devicefull"><strong>Experience : </strong>12 years</li>
								<li class="col-xs-7 devicefull"><strong>Language(s) Spoken : </strong>English, Spanish, Portuguese</li>
								<li class="col-xs-5 devicefull"><strong>Travel Radius : </strong>0-20, 20-50, Any</li>
								<li class="col-xs-7 devicefull"><strong>Status : Active</strong>Looking for the right opportunity.</li>
							</ul>
