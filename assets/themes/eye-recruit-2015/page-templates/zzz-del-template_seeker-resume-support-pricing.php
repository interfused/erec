 <?php
/**
 * Template Name: seeker resume support service checkout
 *
		...
		<div id="content" class="container" role="main">
			<section class="upgrade_membership">
				...
				if ( !empty($servicename) ) { 
					...
					$title = $paymentForms->formTitle;
					$detail_desc = $paymentForms->formcontent;
					?>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="special_box special_logo">
								...
								<h5>What You'll Get Going <?php echo $title; ?></h5>
								<ul>
