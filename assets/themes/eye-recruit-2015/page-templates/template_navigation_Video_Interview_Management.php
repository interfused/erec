                          ...
                          <div class="nav_list_middle">
                            ...
                            <div class="thumbnail">
                              <div href="javascript:void(0);" class="video_overlay">
                                ...
                                <span><a target="_blank" class="btn btn-primary btn-sm" href="<?php echo get_post_meta($post->ID,'wpcf-interview-question-video-link',true);  ?>">Update Response</a></span>
                                <?php  } ?>
                              </div>
                            ...
                            <div class="text-center">
                              <p><strong>Upload Date</strong> :<br> {DATE UPLOADED}</p>
                              <div class="radio">
