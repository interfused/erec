...
function showUpradeNavigationItem($title){
  return '<a id="nav-$title" href="/seeker-pricing/" class="col-sm-3 col-xs-6 devicehalf locked--upgrade">
  <h6>'.$title.'</h6>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-lg-push-3 col-md-push-0">
              <div class="profile_box">
                <div id="profilePic" class="thumbnail">
                  <?php
                  //ICA Avatar
                  echo do_shortcode('[ica_avatar_upload]');
              ...
              <div class="navigation">
                ...
                <div class="nav_items">
                  ...
                  //require premium or higher seeker membership 
                    if( in_array($membershipLevel, array('PREMIUM','ULTIMATE') )  ){
                   //
                     ?>
                    ...
                    <?php }else{ 
                      echo showUpradeNavigationItem('Video Interview Management');
                    }
                    ?>
                  ...
                  <div id="importantDocs">
                    ...
                    <div class="row">
                      <?php 
                    //require at least plus 
                      if( in_array($membershipLevel, array('PLUS','PREMIUM','ULTIMATE') )  ){ ?>
                      <a href="<?php echo site_url();  ?>/job-seekers/education/" class="col-sm-3 col-xs-6 devicehalf">
                        <h6>Education</h6>
                        <i class="nav_icons education_icon"></i>
                      </a>
                      <?php }else{
                        echo showUpradeNavigationItem('Education'); 
                      }?>
                    ...
                    //require at least plus 
                      ...
                      <?php }else{
                        echo showUpradeNavigationItem('Certificates');
                      } ?>
                    ...
                    //require at least plus 
                      ...
                      <?php }else{
                        echo showUpradeNavigationItem('Honors and Awards');
                      } ?>
                    ...
                    //require at least plus 
                      ...
                      <?php }else{
                        echo showUpradeNavigationItem('Licensing');
                      } ?>
                    </div>
                  </div>
                </div>
              ...
              <div class="assessments" id="assesSection">
                <?php if(pmpro_hasMembershipLevel(array('1','Basic'))){ 
                  $upgradeLink='/seeker-pricing/';
                  ?>
                  <div class="membership--need-upgrade">
                    <div class="content">
                      <h2>Upgrade to Unlock</h2>
                      <a class="btn btn-primary" href="/seeker-pricing/">Upgrade Now</a>
                    </div>
                  </div>
                  <?php } ?>
            ...
            ///SHOW JOB SEEKER SUPPORT SERVICES NAV MENU
                  $args = array(
                    'menu' => 'job-seeker-support-services',
                    'menu_class' =>'row',
                    'link_before' => '<h6>',
                    'link_after' => '</h6>',
              ...
              <div class="col-lg-3 col-md-6 col-lg-pull-6 col-md-pull-0">
                <div class="sidebar">
                  ...
                  //RANDOM POLL ID
                  //poll ids are #3 - 14
                    $randomPostID = rand(3,14);
                    echo do_shortcode("[poll id='$randomPostID']");
                    ?>
              ...
              <div class="col-lg-3 col-md-6 col-lg-pull-0 col-md-pull-0">
                <div class="sidebar right_sidebar">
                  ...
                  <div class="light_box last_msurvey">
                    ...
                    <?php echo do_shortcode("[poll id='$randomPostID' type='result']"); ?>
                  </div>
                </div>
              </div>
            </div>
...
if ( getSeekerModalToShow() == 'welcome' ) { 
//check welcome

  ?>
  <script type="text/javascript">
  console.log("guidenewUserTour:  <?php echo $guidenewUserTour; ?>");
  jQuery(document).ready(function(){
...
<script>
jQuery(document).ready(function(){
  jQuery("a.asses_box").attr('href','javascript:void(0)');
});
</script>
<?php } ?>
