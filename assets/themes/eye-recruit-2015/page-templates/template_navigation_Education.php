<?php
/**
 * Template Name: Navigation Education page
 *
...
get_header(); 
	...
	/*$wpdb->query("ALTER TABLE $tableName ADD docType varchar(2555) DEFAULT NULL");*/
	?>
	...
	if ( in_array('candidate', $current_user->roles) ) {
		$select = $wpdb->get_results("SELECT * FROM $tableName WHERE user_id = '".$userID."' AND docType = 'education' ORDER BY id desc");
	}
	else{
		$select = $wpdb->get_results("SELECT * FROM $tableName WHERE user_id = '".$userID."' AND docType = 'education' AND access IN ('Currently Viewable', 'Permission Only') ORDER BY id desc");
	}
			...
			<div id="content" class="container" role="main">
				...
				<section class="navigations">
					<div class="section_title">
						<h3>Education Document <?php echo $breadText; ?></h3>
					...
					<div class="row indent">
						<div class="col-md-9">
							<ol class="breadcrumb">
							  ...
							  <li class="active">Education <?php echo $breadText2; ?></li>
							</ol>
							<?php if($view == 'allow'){ ?>
								<div class="search_bar">
									<p><?php echo $cand_name." ".$verb; ?> stored <span id="noOfRes"><?php echo count($select); ?></span> Education Related Document(s)</p>
								</div>
							<?php } ?>
						</div>
					</div>
					<div class="row indent">
						<div class="col-md-9">
							<?php if($view == 'allow'){ ?>
								...
								<div class="navigations_list"> <!-- education_manage -->
									<div class="row">
										<?php
												...
												<article class="navs_listitem">
													...
													<div class="nav_list_cont">
														<div class="nav_list_middle">
															...
															<div class="thumbnail">
			      												<img src="<?php echo get_stylesheet_directory_uri(); ?>/boxicon/7---Educational-Documents---purchased-[Converted].jpg" class="img-responsive" alt="Resume">
															</div>
								...
								<?php  }else {  
									...
									<div class="well no_document">
											<p><img src="<?php  echo get_stylesheet_directory_uri(); ?>/img/green_checklg.jpg"> <span>You haven’t saved your Education related documents yet!</span></p>
											<p>This is a great time to show a potential employer about a significant Educational accomplishment.  Employers are very interested in Candidates that can show that they have completed studies and have worked though a process to achieve a desired goal. </p>
											<p>Be proud of your Educational accomplishments and start looking to the future!  Maybe continuing your education has been something you have been considering, maybe not.  For right now, let’s just take just as much time as we need to collect all of our Educational documents.  If you need to come back to this step, that is no problem.  We suggest getting the best looking documents you can and sometimes that requires you to  scan documents and then save later.  </p>
										...
										<div class="media">
										  ...
										  <div class="media-body media-middle">
											<p>To receive information on Continuing Education options, click this button and and send us an e-mail.  Tell what you would would like to learn or study and we will included your on any future notifications regarding continuing Education or similar topics from Eyerecruit, Inc., our affiliates or associated centers for Higher Learning.</p>
										  </div>
							...
							<?php   if ( isset($_REQUEST['recruitID']) ) { ?>
								...
								<?php  }else{  ?>
									...
									<div class="special_box navi_thumbnail">
										...
										<a href="<?php echo site_url('/job-seekers/upload-education-doc/'); ?>" class="btn btn-primary btn-sm">Upload</a>
									</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		<div class="modal-body vscroll">
			...
			<h3>Upload your Education Doc</h3>
			<div class="upload-form  upload-form-modal">
				<form action="" method="post">
					...
					<p class="text-center">
						<?php echo SITE_VERBIAGE_PRIVACY_VALUE; ?> Your Education Doc information will be added to your profile.
					</p>
				    <div class="text-center form-group">
				        <button type="button" class="btn btn-primary btn-upload">Submit Education Doc</button>
				    </div>
...
<script type="text/javascript">
	jQuery(document).ready( function() {
	    ...
	    jQuery('.btn-upload').on('click', function(e){
	        ...
	        fd.append('action', 'cvf_upload_educationfiles');   //Action in inc/edit_basic_info.php
	        jQuery.ajax({
	            type: 'POST',
	            url: '<?php echo admin_url("admin-ajax.php"); ?>',
	            data: fd,
...
<?php echo forwardNavigationFiles('Education Document'); ?>