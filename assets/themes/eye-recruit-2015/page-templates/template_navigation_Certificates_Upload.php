<?php
/**
 * Template Name: Navigation Certificates Upload page
 *
					...
					<div class="col-md-9">
						<div class="upload-form">
							<div class="sidebar_title">
								<h4>Upload your Certificate from a device or preferred cloud storage</h4>
							</div>
							<form action="" method="post">
								<div class="row">
									<div class="col-sm-10 col-sm-offset-1">
										...
										<p class="text-right">
											<a id="backtolist" href="<?php echo site_url('/job-seekers/certificates/'); ?>">Cancel</a>
										</p>
									</div>
								</div>
								<p class="text-center">
	        ...
	        jQuery.ajax({
	            ...
	            success: function(response){
	                ...
	                if ( response == '<p class="success">Successfully added.</p>' ) {
						...
						jQuery('#backtolist').html('View All Certificate(s)');
	            	}
	            	else{
	            		jQuery('#uploadedFile').html('');
