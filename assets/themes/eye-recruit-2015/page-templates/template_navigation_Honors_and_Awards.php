<?php
/**
 * Template Name: Navigation Honors and Awards page
 *
...
get_header(); ?>
	...
	if ( in_array('candidate', $current_user->roles) ) {
		$select = $wpdb->get_results("SELECT * FROM $tableName WHERE user_id = '".$userID."' AND docType = 'honors' ORDER BY id desc");
	}
	else{
		$select = $wpdb->get_results("SELECT * FROM $tableName WHERE user_id = '".$userID."' AND docType = 'honors' AND access IN ('Currently Viewable', 'Permission Only') ORDER BY id desc");
	}
		...
		<div id="content" class="container" role="main">
			...
			<section class="navigations">
				<div class="section_title">
					<h3>Honors & Awards <?php echo $breadText; ?></h3>
				...
				<div class="row indent">
					<div class="col-md-9">
						<ol class="breadcrumb">
						  ...
						  <li class="active">Honors & Awards <?php echo $breadText; ?></li>
						</ol>

						<?php if($view == 'allow'){ ?>
							<div class="search_bar">
								<p><?php echo $cand_name." ".$verb; ?> stored <span id="noOfRes"><?php echo count($select); ?></span> Honors & Awards Document(s)</p>
							</div>
						<?php } ?>
					</div>
				</div>
											...
											<article class="navs_listitem">
												...
												<div class="nav_list_cont">
													<div class="nav_list_middle">
														...
														<div class="thumbnail">
		      												<img src="<?php echo get_stylesheet_directory_uri(); ?>/boxicon/9---Honors-&-Awards---Purchased-[Converted].jpg" class="img-responsive" alt="Resume">
														</div>
					...
					<div class="col-md-3">
						...
						<?php   if ( isset($_REQUEST['recruitID']) ) { ?>
								...
								<div class="special_box navi_thumbnail">
									...
									<a href="<?php echo site_url('/job-seekers/upload-honors-and-awards/'); ?>" class="btn btn-primary btn-sm">Upload</a>
								</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		<div class="modal-body vscroll">
			...
			<h3>Upload your Honors and Awards</h3>
			<div class="upload-form  upload-form-modal">
				<form action="" method="post">
				    ...
				    <div class="text-center form-group">
				        <button type="button" class="btn btn-primary btn-upload">Submit Honors and Award</button>
				    </div>
...
<?php echo forwardNavigationFiles('Honors & Award'); ?>