 <?php
/**
 * Template Name: Seeker salary negotiation Services
 *
...
<?php while ( have_posts() ) : the_post(); ?>
	...
	$paymentForms = $wpdb->get_results("SELECT * FROM $formtable WHERE servicetype = 'Salary Nagotiation'");
							...
							<div class="col-sm-4">
								...
								<?php echo (($count == 2)) ? '<span class="popular_badge">Most Popular</span>' : ''; ?>
									<div class="text-center iconArea">
										<h4 class="pricing-table-widget-title"><?php echo str_replace('Salary Nagotiation ', '',  $value->formTitle); ?></h4>
										<h5>
										<?php 
										echo $currencySymbol;
