<?php
/**
 * Template Name: Ontraport Buy Form
 *
...
jQuery(window).load(function(e) {
    jQuery(".post_content link").remove();
	jQuery(".entry-content form").show();
	jQuery(".moonray-form-element-wrapper-contracted").addClass('col-sm-6');
});

</script>
<style>
.entry-content form{ visibility:hidden;}
