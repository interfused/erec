...
<?php 
	...
	{ 
		...
		<ul class="card_billing_info">
			...
			<li><span><?php _e('Account', 'pmpro');?>:</span> <?php echo $pmpro_invoice->user->display_name?> (<?php echo $pmpro_invoice->user->user_email?>)</li>
		...
		<table  id="pmpro_invoice_table" class="table table-bordered pmpro_invoice" width="100%" cellpadding="0" cellspacing="0" border="0">
			<thead>
				<tr>
	...
	else 
	{
		...
		if($invoices)
		{
			?>
		<div class="table-responsive">
			<table class="table table-bordered" id="pmpro_invoices_table" class="pmpro_invoice" width="100%" cellpadding="0" cellspacing="0" border="0">
				<thead>
					<tr>
