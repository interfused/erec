...
function jobify_preview_handler() {
	...
	if ( $job_id ) {
		...
		<style type="text/css">
			header, footer, .jobdetail_page .page-header, .jobdetail_page .jobinterest_links{ display: none !important; }
		</style>
		
		<form method="post" id="job_preview">
			<div class="job_listing_preview_title">
				<input type="submit" name="continuedummy" id="job_preview_submit_button_dummy" class="button" value="<?php echo apply_filters( 'submit_job_step_preview_submit_text', __( 'Proceed to pay &rarr;', 'jobify' ) ); ?>" />
				<input type="submit" name="continue" id="job_preview_submit_button" class="button" style="display:none;" value="<?php echo apply_filters( 'submit_job_step_preview_submit_text', __( 'Submit Listing &rarr;', 'jobify' ) ); ?>" />
				<input type="submit" name="edit_job" class="button" value="<?php esc_attr_e( '&larr; Back', 'jobify' ); ?>" />
		...
		<script type="text/javascript">
			jQuery(document).ready( function() {
				...
				jQuery('.jobdetail_page .page-header, .jobdetail_page .jobinterest_links').remove();
				jQuery('#job_preview_submit_button').val('Proceed to pay →').show();
				jQuery('#job_preview_submit_button_dummy').remove();
			});
		</script>
		<?php
