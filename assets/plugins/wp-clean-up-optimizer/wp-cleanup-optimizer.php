...
if (!defined("clean_up_optimizer_version_number")) {
   define("clean_up_optimizer_version_number", "4.0.12");
}
   ...
   if (is_admin()) {
      ...
      function backend_js_css_for_clean_up_optimizer() {
         ...
         if (in_array(isset($_REQUEST["page"]) ? esc_attr($_REQUEST["page"]) : "", $pages_clean_up_optimizer)) {
            ...
            wp_enqueue_style("clean-up-optimizer-premium-edition.css", plugins_url("assets/admin/layout/css/premium-edition.css", __FILE__));
         }
      }
            ...
            if (!$this->cpo_required_fields($admin_notices[$slug])) {
               ...
               if ($admin_display_check == 0 && strtotime($admin_display_start) <= strtotime($current_date)) {
                  ...
                  if (strpos($slug, 'promo') === FALSE) {
                     ...
                     echo '<div class="update-nag cpo-admin-notice" style="width:96%!important;">
                               <div></div>
