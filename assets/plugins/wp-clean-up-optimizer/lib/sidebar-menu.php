...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      if ($flag == "1") {
         ...
         add_submenu_page("cpo_dashboard", $cpo_support_forum, $cpo_support_forum, "read", "https://wordpress.org/support/plugin/wp-clean-up-optimizer", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "");
         ...
         add_submenu_page("cpo_dashboard", $cpo_upgrade, $cpo_upgrade, "read", "cpo_upgrade", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_upgrade");
      }
      ...
      /*
        Function Name: cpo_upgrade
        Parameter: No
        Description: This function is used to create the cpo_upgrade menu.
        Created On: 07-04-2017 1:15
        Created By: Tech Banker Team
       */
      function cpo_upgrade() {
         global $wpdb;
         $user_role_permission = get_users_capabilities_for_clean_up_optimizer();
         if (file_exists(CLEAN_UP_OPTIMIZER_DIR_PATH . "includes/translations.php")) {
            include CLEAN_UP_OPTIMIZER_DIR_PATH . "includes/translations.php";
         ...
         if (file_exists(CLEAN_UP_OPTIMIZER_DIR_PATH . "views/upgrade/upgrade.php")) {
            include_once CLEAN_UP_OPTIMIZER_DIR_PATH . "views/upgrade/upgrade.php";
         }
         if (file_exists(CLEAN_UP_OPTIMIZER_DIR_PATH . "includes/footer.php")) {
            include_once CLEAN_UP_OPTIMIZER_DIR_PATH . "includes/footer.php";
         }
