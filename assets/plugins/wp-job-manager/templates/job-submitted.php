...
switch ( $job->post_status ) :
	...
	break;
	case 'pending' :
		printf( __( '<h2 class="text-center">%s submitted successfully. Your listing will be visible once approved.<h2>', 'wp-job-manager' ), $wp_post_types['job_listing']->labels->singular_name, get_permalink( $job->ID ) );
	break;
	default :
