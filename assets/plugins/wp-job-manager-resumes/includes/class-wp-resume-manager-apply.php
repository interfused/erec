		...
		if ( ! empty( $_POST['wp_job_manager_resumes_apply_with_resume'] ) ) {
			...
			try {
				...
				if ( $this->send_application( $job_id, $resume_id, $application_message ) ) {
					$this->message = __( 'SUCCESS!  You have successfully applied to this Job Posting!  You will be able to find it later by going to your Jobs You Applied To from your Dashboard or from Preferences.', 'wp-job-manager-resumes' );
