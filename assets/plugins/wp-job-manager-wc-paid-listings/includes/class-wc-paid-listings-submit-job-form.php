				...
				<div class="container">
					<form method="post" id="job_package_selection">
						<div class="job_listing_packages_title">
							<input type="submit" name="continue" class="button" value="<?php //echo apply_filters( 'submit_job_step_choose_package_submit_text', $button_text ); ?> Continue" />
							<input type="hidden" name="job_id" value="<?php echo esc_attr( $job_id ); ?>" />
							<input type="hidden" name="step" value="<?php echo esc_attr( $step ); ?>" />
							<input type="hidden" name="job_manager_form" value="<?php echo $form_name; ?>" />
							<h2><?php _e( 'NO RISK.  NO HIDDEN FEES.  NO MINIMUMS.', 'wp-job-manager-wc-paid-listings' ); ?></h2>
						</div>
