...
//		add_action( 'login_form_register', array( $this, 'redirect_to_custom_register' ) );
		...
		//added so that woocommerce default forgot password takes lower priority
		add_filter('lostpassword_url', array( $this, 'custom_lost_password_url_filter' ), 1000, 2);
...
//		add_shortcode( 'custom-register-form', array( $this, 'render_register_form' ) );
	...
	public function custom_lost_password_url_filter($lostpassword_url, $redirect ) {
  return home_url( 'member-password-lost' );
}
