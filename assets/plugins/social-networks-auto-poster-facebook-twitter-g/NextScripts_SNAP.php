...
*/
define( 'NextScripts_SNAP_Version' , '4.2.1' ); define( 'NextScripts_SNAP_Version_Date' , 'Apr 4, 2018' ); require_once "inc/nxs_functions_wp.php"; if(!defined( 'NXSSNAP_BASENAME' ) ) define( 'NXSSNAP_BASENAME', plugin_basename( __FILE__ ) );
